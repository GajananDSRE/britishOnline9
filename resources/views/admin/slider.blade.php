				...
				<tbody>
					...
					<tr>
						...
						<td style="font-size: 20px;">
							<i class="fa fa-edit" data-toggle="modal" data-target="#editSlider" data-id="{{ $slider->id }}"></i>
...
<div class="modal hide fade" id="editSlider" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog modal-lg modal-dialog-centered">    
      	<!-- Modal content-->
      	<div class="modal-content">
        	<div class="modal-header">
        ...
        <div class="modal-body">          
			...
			{{csrf_field()}}
				...
				<table class="table" id="dynamic_field">
					...
					<tr>
						<td><input type="file" name="file" id="imageinput" data-rule-required="true" accept="image/*"  /></td>
						<td><input type="text" name="title" data-rule-required="true" placeholder="Title" class="form-control"/></td>
						<td><input type="text" name="sort_order" data-rule-required="true" v-model="sort_order_increment" placeholder="Sort Order" class="form-control"/></td>
						
					</tr>
				</table>
                <div class="row text-center mt-3" style="justify-content: center;">
					<div class="col-md-6 col-sm-12">
						<button type="button" class="btn btn-outline-primary"  name="submit" id="submit" >Update</button>
					</div>
				</div>
			</form>		
        </div>
