		...
		<div class="row justify-content-center">
			<div class="col-xl-4 col-lg-4 col-md-4 col-sm-12 mb-30 ">
				<div class="pd-20 card-box height-100-p">
					...
					{{ Form::open(array('url' => 'add-exchange','autocomplete'=>'off','id'=>'exchange','enctype'=>'multipart/form-data')) }}
						<div class="form-group">
							{{ Form::label('Exchange Name', 'Exchange Name') }}
							{{ Form::text('name','',['class'=> 'form-control','placeholder'=>'BritishOnline9.com'])}}
						</div>
						<div class="form-group">
							{{ Form::label('url', 'URL') }}
							{{ Form::text('url','',['class'=> 'form-control','placeholder'=>'Exchange URL'])}}
						</div>
						<div class="form-group">
						...
						<div class="row">
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
									...
									{{ Form::text('demo_id','',['class'=> 'form-control','placeholder'=>'kaka11'])}}
								</div>
							</div>
							<div class="col-md-6 col-sm-12">
								<div class="form-group">
							...
							<div class="form-group table-responsive">
								{{ Form::label('Select Game', 'Select Game',['class'=>'time-label pl-4']) }}
									<ul class="d-flex ml-4">
										<li class="p-4">
											{{ Form::checkbox('sport[]', 'cricket',false,['id'=>'cricket']) }}
											{{ Form::label('Cricket', 'Cricket', ['class'=>'check']) }}									
											<div class="check"></div>
										</li>										
										<li class="p-4">
											{{ Form::checkbox('sport[]', 'football',false,['id'=>'football']) }}
											{{ Form::label('Football', 'Football', ['class'=>'check']) }}						
											<div class="check"><div class="inside"></div></div>
										</li>										
										<li class="p-4">
											{{ Form::checkbox('sport[]', 'tennis',false,['id'=>'tennis']) }}
											{{ Form::label('Tennis', 'Tennis', ['class'=>'check']) }}						
											<div class="check"><div class="inside"></div></div>
										</li>
										<li class="p-4">
											{{ Form::checkbox('sport[]', 'casino',false,['id'=>'casino']) }}
						...
						<div class="form-group">
							...
							{{ Form::text('balance','',['class'=> 'form-control','placeholder'=>'$20000'])}}
						</div>
						<div class="row text-center" style="justify-content: center;">
							<div class="col-md-6 col-sm-12">
								{{ Form::submit('Add Exchange',['class' => 'btn btn-outline-primary'])}}
							</div>
						</div>
					{{ Form::close() }}
				</div>
